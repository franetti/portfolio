...
function Home() {    
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_yvk3o2s', 'template_iocys7u', form.current, 'Kqp6QquReDazEdiBa')
        .then((result) => {
    ...
    useEffect(() => {            
        ...
        timeline_home.from(iframeRef, {scale:0.2,duration: 2, opacity: 0 },"-=2")
        .from([text1, text2, text3, text4], {  duration: 1.2, skewY: 15, y: 500,
             stagger: {
                amount: .2
            }            
        },"-=1.5")        
        ...
        timeline_scroll.to([text1, text2, text3, text4], { duration: 1.5, skewY: 25, y: 500 },"same")
        ...
        .to(titleProjects2, {xPercent:-100,  ease:"power1.inOut", opacity:0}, "same2")        
        .to(titleProjects1, {xPercent:100,  ease:"power1.inOut", opacity:0},"same2")        
        .to(iframeRef,{scale:4.5, ease:"power1.in",duration:2.5},"same2")
        .to(mask,{display:"none"},"same2")

        .from(project1,{xPercent:-100,  ease:"power1.inOut", delay:1.5, duration:1.5},"same2")
        .from(gif1,{xPercent:100,  ease:"power1.inOut",  delay:1.5, duration:1.5},"same2")
        ...
        .from(project2,{xPercent:-100,  ease:"power1.inOut",duration:1.5},"same4")
        .from(gif2,{xPercent:100,  ease:"power1.inOut",duration:1.5},"same4")

        .to(project2, {duration:1.5},"same40")
        .to(gif2,{duration:1.5},"same40")

        .from(project3,{xPercent:-100,  ease:"power1.inOut",duration:1.5},"same8")
        .from(gif3,{xPercent:100,  ease:"power1.inOut",duration:1.5},"same8")

        .to(project2, {duration:1.5},"same80")
        .to(gif2,{duration:1.5},"same80")
        
        .from(".about .box_titleProject_top",{yPercent:50, ease:"power1.in",duration:2.5,opacity:"0"},"same6")
        .from(".zuki",{yPercent:50, ease:"power1.in",duration:2.5,opacity:"0"},"same6")
        ...
        ScrollTrigger.create({            
            ...
            start: "top top",              
            end:() => "+=" + (hero.offsetHeight+section1.offsetHeight + project1.offsetHeight*6 ),       
    ...
    <div className='home' ref={el => home = el}>        
        ...
        <div ref={el => hero = el} className="hero" style={{margin:"auto"}}>            
            <div className="container" style={{flexDirection:"column"}}>
                ...
                <div className="left-side-quote">
                    <p ref={el => p1 = el}>Desarrollador REACT / NODE / .NET  <br /> Estudiante universitario <br /> Buenos aires, Argentina</p>
                </div>       
            </div> 
                       
            <div className="wrapper_iframe">                  
                <div className="container_iframe">
                    <iframe ref = {el=>iframeRef = el} src='https://my.spline.design/noiselightscopy-e997e2855e892ded4d1170fd4cbc7c20/' frameborder='0' width='100%' height='100%'></iframe>                             
        ...
        <div className="project1" >
            <div className='box_titleProject_top' ref={el => project1 = el}>                         
                <div>
                    ...
                    <p >Una web creativa basada en animaciones con GSAP y React<br/>
                        siguiendo los estandares de diseño de <a href='https://www.awwwards.com'>AWWWARDS</a><br />             
                        manteniendo el foco en la experiencia del usuario<br/><br/>
                        Utiliza Gatsby SSR para optimizar el renderizado<br/>                    
                    </p>
                    <a target="_blank" rel="noopener noreferrer" href="https://gatsby-gsap.netlify.app/" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"10px",textDecoration:"none"}}>View Demo</a>
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/franetti/creative_agency_web" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"15px",textDecoration:"none"}}>Github</a>
                </div>
            </div>
        ...
        <div className="project" >
            <div className='box_titleProject_top' ref={el => project2 = el}>                         
                <div>
                    <h1>MERN STACK</h1>                  
                    <p >Un ecommerce moderno hecho con REACT, NODE, EXPRESS y MONGO                        
                    </p>
                    <a target="_blank" rel="noopener noreferrer" href="https://fakeshop-mern.netlify.app/" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"10px",textDecoration:"none"}}>View Demo</a>
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/franetti/fakeshop_client" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"15px", textDecoration:"none"}}>Github</a>
                </div>
            </div>
        ...
        <div className="project" >
            <div className='box_titleProject_top' ref={el => project3 = el}>                         
                <div>
                    <h1>FIREBASE CRUD</h1>                  
                    <p >El clasico create, read, update and delete <br />
                        <br /> implementado con Firebase para la persistencia de datos y Next SSR.
                        <br/>Hecho en REACT
                    </p>
                    <a target="_blank" rel="noopener noreferrer" href="https://simpleabm-firebase.netlify.app/" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"10px",textDecoration:"none"}}>View Demo</a>
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/franetti/simpleabm_firebase" style={{padding:"10px 60px", background:"darkgray", border:"0", marginLeft:"15px", textDecoration:"none"}}>Github</a>
                </div>
            </div>
                ...
                <div className='contact_box'>                         
                    <div>
                        <div  style={{flexDirection:"initial "}}>                                                                
                            ...
                            <p style={{fontSize:"4rem", margin:"15px 0 0 15px", fontFamily:'Roboto Mono'}}>contacto</p>
                        </div>
                        <ul>
                            <li>franco.martinetti@gmail.com</li>
                            <li><a href="https://www.linkedin.com/in/franco-martinetti-243a791ab/" style={{textDecoration:'none',color:"inherit"}}>linkedin</a></li>
                        </ul>
                    </div>
                    <form ref={form} onSubmit={sendEmail}>
                        <div style={{marginBottom:'12px'}}>
                            <label htmlFor="">Nombre</label>
                            <input type="text" required name="name" onChange={(e) => handleInput(e.target)}/>
                        </div>
                        <div style={{marginBottom:'12px'}}>
                        ...
                        <div style={{marginBottom:'12px'}}>
                            ...
                            <textarea  id="" cols="40" rows="10" required  name="message"></textarea>
                        </div>
                        <div>
